...
def make_front_matter(title: str, subtitle: str, author: str, year: str,
    ...
    isbn_lines = []
    if hardcover_isbn:
        isbn_lines.append(f"ISBN: {esc(hardcover_isbn)} (hardcover)")
    if paperback_isbn:
        isbn_lines.append(f"ISBN: {esc(paperback_isbn)} (paperback)")
...
// Uses the shared WSS title-page and copyright-page layout.
